...
Data Set Source: [Communities and Crime](https://archive.ics.uci.edu/dataset/183/communities+and+crime). UC Irvine, Michael Redmond, 2009
Observation Sources: 1990 US Census, 1990 US Lemas Survey, 1995 FBI UCR

-   Load variable names
-   Load data set
-   Combine data set and variable names
-   Remove non-predictive variables
-   Handle missing values
-   Clean data

```{r data set and processing, echo=FALSE}
