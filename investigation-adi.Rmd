...
communities$Region <- as.factor(ifelse(communities$State%in%c(8,22,24,32,34,35,42,44,51), "Northeast",
                                       ifelse(communities$State%in%c(16,17,18,19,25,26,28,30,37,39,46,55), "Midwest",
                                       ifelse(communities$State%in%c(1,5,9,10,11,12,20,21,23,27,36,40,45,47,48,52,54), "South",
                                       ifelse(communities$State%in%c(2,4,6,7,14,15,29,31,33,41,50,53,56), "West", "Territory")))))
...
ggplot(data = communities,
  ...
  geom_point(alpha = 0.3, colour = "steelblue4") +
  geom_smooth(method = lm, fullrange = TRUE, colour = "steelblue1") +
...
ggplot(data = communities,
  ...
  geom_point(alpha = 0.1, colour = "steelblue4") +
  geom_smooth(method = lm, fullrange = TRUE, colour = "steelblue1") +
